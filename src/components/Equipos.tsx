...
console.log(empleadoConfigs);
  ...
  const [empleados, setEmpleados] = useState<Empleado[]>([
    ...
    { id: 3, nombre: "Toyota/Autobus 30 Psj/I067665/E-0856", edad: 30, puesto: "Desarrollador" },
    { id: 4, nombre: "Isuzu/Camioneta 4x4 Isuzu Dmax/L248192/E-0439", edad: 28, puesto: "Diseñadora" },
  ]);
